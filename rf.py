...
class RandomForestClassifierWrapper:
    ...
    def optimise(self, X, y, groups=None, param_grid=DEFAULT_PARAM_GRID, outdir='optimised_params/rf.pkl'):
        def objective(space):
        ...
        best = fmin(fn=objective, space=param_grid, algo=tpe.suggest, max_evals=100, trials=trials, 
